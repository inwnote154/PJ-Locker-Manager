            ...
            <li class="nav-item active">
                ...
                <div id="Allreport" class="collapse show" aria-labelledby="headingFour" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="../AllReport/date_select.php">รายงานการตรวจสอบ</a>
                            ...
                            <form id="dateForm">
                                <table class="w-100">
                                    <tr>
                                        ...
                                        <td class="p-2" for="format">รูปแบบ:</td>
                                        <td>
                                        ...
                                        <td class="p-2" for="type">ประเภท:</td>
                                        <td>
                                        ...
                                        <td class="p-2" for="building">อาคาร:</td>
                                        <td>
