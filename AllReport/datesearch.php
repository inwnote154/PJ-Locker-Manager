...
$sql = "SELECT * FROM format_audit WHERE createdate BETWEEN ? AND DATEADD(day,1,?) AND selection = '$selection'AND typeaudit = '$type' ";
            ...
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="no-gutters align-items-center">
                        ...
                        อาคาร : '.$buildname.'<br>เพศ : '.$intitail.'<br>วิธีการตรวจ : '.$row['auditchoose'].'<br>
                        <a href="../Audit/auditresult1.php?id_selection='.$row['ID'].'"class="btn btn-success btn-icon-split btn-sm w-100">
            ...
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="no-gutters align-items-center">
                        วันที่ : '.$row['createdate']->format('Y-m-d').'<br>ตู้'.$type.'<br>
                        อาคาร : '.$buildname.'<br>เพศ : '.$intitail.'<br>วิธีการตรวจ : '.$row['auditchoose'].'<br>
                        <a href="../Audit/auditresult1.php?id_selection='.$row['ID'].'"class="btn btn-info btn-icon-split btn-sm w-100">
                            <span class="icon text-white-50 w-25">
                                <i class="fas fa-flag"></i>
                            </span>
            ...
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                    <div class="no-gutters align-items-center">
                        วันที่ : '.$row['createdate']->format('Y-m-d').'<br>ตู้'.$type.'<br>
                        อาคาร : '.$buildname.'<br>เพศ : '.$intitail.'<br>วิธีการตรวจ : '.$row['auditchoose'].'<br>
                        <a href="../Audit/auditShow.php?id_selection='.$row['ID'].'"class="btn btn-warning btn-icon-split btn-sm w-100">
                            <span class="icon text-white-50 w-25">
                                <i class="fas fa-flag"></i>
                            </span>
