        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                                    ...
                                    <div class="col mr-2">
                                        <?php
                                          if ($_SESSION['selection']==0.5) {
                                            echo'<div class="h1 mb-0 font-weight-bold text-gray-800 text-center">เลือก</h1>
                                            </div>';
                                          }else{
                                            echo'<div class="h1 mb-0 font-weight-bold text-gray-800 text-center">เลือก</h1>
                                            </div>';
                    ...
                    <div class="col-xl-12 col-md-12 mb-4">
                    <a class="Ahover text-gray-800 text-decoration-none" <?php echo'href="audittable.php?type=out"'; ?>>
                        <div class="card border-bottom-primary shadow h-100 py-1">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col-1 m-0 h2 font-weight-bold text-gray-800 text-center">></div>
                                    <div class="col mr-2">
                                        <div class="h1 mb-0 font-weight-bold text-center">รองเท้าภายนอก</div>
                                    </div>
                                    <div class="col-1 m-0 h2 font-weight-bold text-gray-800 text-center"><</div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-12 col-md-12 mb-4">
                    <a class="Ahover text-gray-800 text-decoration-none" <?php echo'href="audittable.php?type=buddy"'; ?>>
                        <div class="card border-bottom-primary shadow h-100 py-1">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col-1 m-0 h2 font-weight-bold text-gray-800 text-center">></div>
                                    <div class="col mr-2">
                                        <div class="h1 mb-0 font-weight-bold text-center">รองเท้าบัดดี้</div>
                                    </div>
                                    <div class="col-1 m-0 h2 font-weight-bold text-gray-800 text-center"><</div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-12 col-md-12 mb-4">
                    <a class="Ahover text-gray-800 text-decoration-none" <?php echo'href="audittable.php?type=shirt"'; ?>>
                        <div class="card border-bottom-primary shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col-1 m-0 h2 font-weight-bold text-gray-800 text-center">></div>
                                    <div class="col mr-2">
                                        <div class="h1 mb-0 font-weight-bold text-center">ตู้ล็อคเกอร์เก็บของ</div>
                                    </div>
                                    <div class="col-1 m-0 h2 font-weight-bold text-gray-800 text-center"><</div>
                                </div>
                            </div>
                    ...
                    <?php
                      ...
                      <div>
                          <div>หัว</div>
                          <div><a href="ChooseAudit.php?choose=half">half</a></div>
                          <div><a href="ChooseAudit.php?choose=full">full</a></div>
                      </div>    
                      <?php
                    }              
                    ?>
