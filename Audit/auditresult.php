                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered text-center" width="100%" cellspacing="0">
                                    ...
                                    WHERE format_id = '$id_selection'  AND staudit  = 'ok'
                                    ";
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">เลือกเพศที่จะทำการตรวจ</h5>
                                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">×</span>
                                    </button>
                                </div>
                                <form action="auditdetail.php" method="post">
                                                ...
                                                <td class="pb-3">
                                                    <div class="form-check form-check-inline">
                                                        <input
                                                            ...
                                                            value="ตรวจด้วยตนเอง"
                                                        />
                                                        <label class="form-check-label" >ตรวจด้วยตนเอง</label>
                                                    </div>
                                                </td>
                                                <td class="pb-3">
                                                    <div class="form-check form-check-inline">
                                                        <input
                                                            ...
                                                            name="choose"
                                                            id="choose"
                                                            value="ตรวจด้วยกล้องวงจรปิด"
                                                        />
                                                        <label class="form-check-label" >ตรวจด้วยกล้องวงจรปิด</label>
                                                    </div>
                                                </td>
                                            </tr>
                                            <input type="hidden" name="selection" id="selection" <?php echo'value="'.$selection.'"' ?>/>
                                            <input type="hidden" name="type" id="type" <?php echo'value="'.$type.'"' ?>/>
                                            <input type="hidden" name="build" id="build" <?php echo'value="'.$_SESSION['build'].'"' ?>/>
                                        </table>
                                    </div>
                  ...
                  <div class="container-fluid">
                    <div class="row mb-3">
                        <div class="col-2 ps-3 pe-3">
                            ...
                            $nowmount = date('m');
                            $nowyear = date('Y');
                            if($month == $nowmount && $year == $nowyear){
                            ?>
                            <button data-toggle="modal" data-target="#ChooseModal" class="btn btn-primary btn-icon-split w-100">
                                    <?php
                            }
                            else{
                                    ?>
                            <button disabled="disabled" data-toggle="modal" data-target="#ChooseModal" class="btn btn-primary btn-icon-split w-100">
                                    <?php
                            }
                                    ?>
                                <span class="icon text-white-50 w-25">
                                ...
                                <span class="text w-75">เพิ่ม</span>
                            </button>
                        </div>
                        <div class="col-8"></div>
                        <div class="col-2 ps-3 pe-3">
                            <a href="audittable.php" class="btn btn-info btn-icon-split w-100">
                                <span class="icon text-white-50 w-25">
                                    <i class="fas fa-arrow-right"></i>
                                </span>
                                <span class="text w-75">ย้อนกลับ</span>
                    ...
                    WHERE   YEAR(createdate) = '$year' AND MONTH(createdate) = '$month' AND selection = '$selection' AND typeaudit = '$type' AND build = '$build'
                    ORDER BY CONVERT(datetime,createdate) DESC";
