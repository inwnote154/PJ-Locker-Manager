...
if ($conn) {
    ...
    if($rowcheck){
        ...
        if(sqlsrv_num_rows($result)>0){
            header('Location:showbuddy.php?message2=1&employee_buddy='.$employeeBuddy.'&status='.$Startstatus);
        }else{ 
            ...
            if ($stmt !== false ) {
                if (isset($_POST['AllEdit'])){
                    ...
                    header('Location:showbuddy.php?message1=1&employee_buddy='.$employeeBuddy.'&status='.$status);
                }
