                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-4 text-dark shadow">
                                ...
                                <div class="card-body">
                                  <form action="addbuddy.php" method="post">
                                    <table class="container-fluid">
                                        ...
                                        ?>
                                        <tr>
                                            <td class=' p-2 pb-4 align-middle' width='30%'>พนักงาน</td>
                                            <td class=' p-2 pb-4 align-middle' width='70%'>
                                            <div>
                                                <?php
                                                $idcard = $_GET['idcard'];
                                                $name = $_GET['name'];
                                        ...
                                        <tr>
                                            <td class=' p-2 pb-4 align-middle' width='30%'>รหัสตู้</td>
                                            <td class=' p-2 pb-4 align-middle' width='70%'>
                                            <div>
                                        ...
                                        <tr>
                                            ...
                                            <div>
                                                ...
                                                data-live-search="true">
                                                <?php
                                                $sql1 = "SELECT * FROM employee WHERE stemployee = 'ok'AND idcard NOT IN (SELECT idcard FROM Data_locker WHERE TypeLocker = 'buddy')
                                                ";
                                                $stmt = sqlsrv_query($conn, $sql1);
                                                while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                        ...
                                        <tr>
                                            ...
                                            <div>
                                                ...
                                                echo ('<input class="form-control form-control-sm" type="text" id="employee_buddy" 
                                                name="employee_buddy" value="'.$employeeBuddy.'"readonly>
