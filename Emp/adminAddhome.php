...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="../Emp/adminAddhome.php">เพิ่มพนักงาน</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                                ...
                                <div class="card-body">
                                  <form action="adminAdd.php" method="post">
                                    <table class="container-fluid">
                                      <tr>
                                        <td class=' p-2 pb-4' width='10%'>รหัสพนักงาน</td>
                                        <td class=' p-2 pb-4' width='40%'>
                                          <input class="form-control form-control-sm" type="text" id="employee_id" name="employee_id" required>
                                        </td>
                                        <td class=' p-2 pb-4' width='10%'>คำนำหน้า</td>
                                        <td class=' p-2 pb-4' width='40%'>
                                          <!-- <input type="text" id="employee_in" name="employee_in"> -->
                                        ...
                                        <td class=' p-2 pb-4' width='10%'>ชื่อ</td>
                                        <td class=' p-2 pb-4' width='40%'>
                                          <input class="form-control form-control-sm" type="text" id="employee_name" name="employee_name" required>
                                        </td>
                                        <td class=' p-2 pb-4' width='10%'>นามสกุล</td>
                                        <td class=' p-2 pb-4' width='40%'>
                                          <input class="form-control form-control-sm" type="text" id="employee_sur" name="employee_sur" required>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class=' p-2 pb-4' width='10%'>แผนก</td>
                                        <td class=' p-2 pb-4' width='40%'>
                                          <select class="form-control form-control-sm select2" id="employee_depart" name="employee_depart"
                                          data-live-search="true">
                                          <?php
                                            while($row2 = sqlsrv_fetch_array($stmt2, SQLSRV_FETCH_ASSOC)){
                                              echo "
                                              <option value='".$row2['departmentno']."'>". $row2['departmentname']."</option>";
                                            }
                                            
                                          ?>
                                          </select>
                                        </td>
                                        <td class=' p-2 pb-4' width='10%'>ไลน์ผลิต</td>
                                        <td class=' p-2 pb-4' width='40%'>
                                          <select class="form-control form-control-sm select2" id="employee_line" name="employee_line"
                                          data-live-search="true">
                                          <?php
    ...
    <div class="modal fade" id="AddModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">เพิ่มพนักงานเรียบร้อยแล้ว</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
    ...
    <!-- Addfailed Modal-->
    <div class="modal fade" id="AddfailedModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">ไม่สามารถเพิ่มพนักงานได้</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
