                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-3 ps-3 pe-3">
                            <?php echo'<a href="file_list.php?id='.$id_selection.'" class="btn btn-primary btn-icon-split w-100">'?>
                                <span class="icon text-white-50 w-25">
                                    <i class="fas fa-download"></i>
                                </span>
                                <span class="text w-75">ไฟล์ที่แนบมาด้วย</span>
                            </a>
                        </div>
                        <?php
                        $sql = "SELECT staudit FROM format_audit WHERE ID = '$id_selection'";
                        $stmt3 = sqlsrv_query($conn,$sql);
                        $row = sqlsrv_fetch_array($stmt3, SQLSRV_FETCH_ASSOC);
                        if($row['staudit']==='complete'){
                            echo'<div class="col-5"></div>
                            <div class="col-2 ps-3 pe-3">';
                        }else{
                            echo'<div class="col-3 ps-3 pe-3">
                                <a href="managercomplete.php?id_selection='.$id_selection.'" class="btn btn-success 
                                btn-icon-split w-100">';?>
                                    <span class="icon text-white-50 w-25">
