                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-6 text-dark shadow">
                                ...
                                <div class="card-body">
                                  <form action="addout.php" method="post">
                                    ...
                                    <?php
                                      ...
                                      <tr>
                                        ...
                                        <td class=' p-2 pb-4' width='70%'>
                                          <div>
                                            ...
                                            data-live-search="true">
                                              <?php
                                              $sql1 = "SELECT * FROM employee WHERE stemployee = 'ok' AND idcard NOT IN (SELECT idcard FROM Data_locker WHERE TypeLocker = 'out')
                                              ";
                                              $stmt = sqlsrv_query($conn, $sql1);
                                              while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                      ...
                                      <tr>
                                        ...
                                        <td class=' p-2 pb-4' width='70%'>
                                          <div>
                                            <?php
                                              $employeeBuddy = $_GET['employee_out'];
