                ...
                <div class="container-fluid">
                    <?php
                      if ($conn) {
                        ...
                        $status = 0;
                        $statusL = '';
                        $sql3 = "SELECT COUNT(*)AS total FROM Accesslog WHERE LockerNumber = ?  AND TypeLocker = 'out'AND StatusEm = 'active'";
                        $params3 = array($employeeout);
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="card mb-6 text-dark shadow">
                                ...
                                <?php
                                    ...
                                    WHERE LockerNumber = ? AND StatusEm = 'active'AND TypeLocker = 'out'";
                                    ...
                                    while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                        ...
                                        echo ('
                                        <td class="p-2 border">
                                        <a href="editout.php?employee_id='. $row['EmployeeID'].'&employee_out='.$employeeout.'"class="btn btn-danger btn-icon-split">
                                    ...
                                    echo'</table>';
                                    $sql2 = "SELECT * FROM locker_out WHERE out_number = ?";
                                    $params2 = array($employeeout);
                                    $stmt2 = sqlsrv_query($conn, $sql2, $params2 );
                                    while ($row = sqlsrv_fetch_array($stmt2, SQLSRV_FETCH_ASSOC)) {
                                        // echo $row['status_out'];
                                        if($row['status_out']>0){
                                            echo ('<div class="mt-3"><center>
                                            <a href="adduserout.php?employee_out='.$employeeout.'&status='.$stat.'"class="btn btn-success btn-icon-split">
                                                <span class="icon text-white-50">
                                    ...
                                    echo ('<div class="mt-3"><center>
                                    <a href="lockerout.php"class="btn btn-primary btn-icon-split">
                                        <span class="icon text-white-50">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql = "SELECT * FROM locker_break WHERE lockernumber = ? AND typelocker = 'out' ORDER BY breakdate DESC ";
                                                $params = array($employeeout);
                                                $stmt = sqlsrv_query($conn, $sql,$params );
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="../report/editstatus.php" method="post">
                    ...
                    <?php
                        echo ('
                            <input class="form-control form-control-sm" type="number" name="stat" id="stat" value="'.($rowcount2['total']+$stat).'">
