                ...
                <div class="container-fluid">
                    <?php
                        if ($conn) {
                            ...
                            $stat = $_GET['status'];
                            $statusL = '';
                            $sql3 = "SELECT COUNT(*)AS total FROM Accesslog WHERE LockerNumber = ?  AND TypeLocker = 'shirt'AND StatusEm = 'active'";
                            $params3 = array($employeeshirt);
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="card mb-6 text-dark shadow">
                                <div class="card-header">
                                    แก้ไขตู้ <?php echo $employeeshirt ?>
                                </div>
                                <div class="card-body">
                                <?php
                                ...
                                <?php
                                    ...
                                    WHERE LockerNumber = ? AND StatusEm = 'active' AND TypeLocker = 'shirt'";
                                    ...
                                    while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                        ...
                                        echo ('
                                        <td class="p-2 border">
                                        <a href="editshirt.php?employee_id='. $row['EmployeeID'].'&employee_shirt='.$employeeshirt.'"class="btn btn-danger btn-icon-split">
                                    ...
                                    echo'</table>';
                                    $sql2 = "SELECT * FROM locker_shirt WHERE shirt_number = ?";
                                    $params2 = array($employeeshirt);
                                    $stmt2 = sqlsrv_query($conn, $sql2, $params2 );
                                    while ($row = sqlsrv_fetch_array($stmt2, SQLSRV_FETCH_ASSOC)) {
                                        // echo $row['status_shirt'];
                                        if($row['status_shirt']>0){
                                            echo ('<div class="mt-3"><center>
                                            <a href="addusershirt.php?employee_shirt='.$employeeshirt.'&status='.$stat.'"class="btn btn-success btn-icon-split">
                                                <span class="icon text-white-50">
                                    ...
                                    echo ('<div class="mt-3"><center>
                                    <a href="lockershirt.php"class="btn btn-primary btn-icon-split">
                                    <span class="icon text-white-50">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql = "SELECT * FROM locker_break WHERE lockernumber = ? AND typelocker = 'shirt' ORDER BY breakdate DESC ";
                                                $params = array($employeeshirt);
                                                $stmt = sqlsrv_query($conn, $sql,$params );
                ...
                <form action="../report/editstatus.php" method="post">
                    ...
                    <?php
                        echo ('
                            ...
                            <input type="hidden" name="type" id="type" value="shirt" readonly>
                            <input type="hidden" name="number" id="number" value="'.$employeeshirt.'" readonly>
