...
<body class="bg-gradient-primary">
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="admin.php" method="post">
                                        ...
                                        <div class="d-md-flex justify-content-md-end mt-1">
                                            <a href="Index.php" class="d-md-flex">
                                                <button type="button" class="miniText">CANCEL</button>
                                            </a>
                                        </div>
    ...
    <!-- Faild Modal-->
    <div class="modal fade" id="FaildModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">ชื่อผู้ใช้หรือรหัสผ่านไม่ถูกต้อง</h5>
